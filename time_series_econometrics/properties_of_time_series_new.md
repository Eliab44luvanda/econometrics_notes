...
:::: cell
::: cell-output-display
![Multiple simple random-walk sample paths (5)](properties_of_time_series_new_files/figure-markdown/unnamed-chunk-1-1.png)
:::
::::
...
:::: cell
::: cell-output-display
![Gaussian white noise (i.i.d. N(0,1))](properties_of_time_series_new_files/figure-markdown/white_noise-1.png)
:::
::::
...
: Summary comparison of weak (second‑order) and strong (strict) stationarity: definitions, requirements, implications, and practical considerations.