...
\title{Supply-Side Teacher Forecasting Framework}
\subtitle{Primary and Secondary Education in Tanzania}
\author{Prepared for MOEST and PO-RALG}
\date{March 2026}
...
\begin{frame}[plain]
  ...
  \vspace{0.2cm}
  {\usebeamerfont{subtitle}\color{white!92}\insertsubtitle\par}
  \vspace{0.7cm}
  ...
  \vspace{0.35cm}
  {\color{white!80}\small \insertdate\par}
\end{frame}
