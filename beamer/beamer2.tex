...
\begin{frame}[plain]
  ...
  Prime Minister's Office - Regional Administration and Local Government (PMO-RALG)\par}
  \vfill
...
\begin{itemize}
  ...
  \item These gains have increased \highlight{demand for teachers}, especially in areas with growing enrolment.
...
\justifying
A regular forecasting system enables MOEST and PMO-RALG to shift from reactive staffing decisions to \highlight{proactive workforce planning}.
\end{block}
\end{columns}
\end{frame}
...
\begin{itemize}
  ...
  \item \highlight{PMO-RALG}: deployment, LGA coordination, stock and attrition data, and local interpretation of forecast results.
...
A joint \highlight{Teacher Workforce Planning Technical Working Group} should review data, validate assumptions, agree on scenarios, and sign off on forecast outputs.
\end{block}
\end{frame}
...
\justifying
It is \highlight{transparent}, requires relatively little data, supports \highlight{data-driven decisions}, and can be institutionalized while maintaining attention to \highlight{equity, gender, and inclusion}.
\end{block}
\end{columns}
\end{frame}
...
\]
\begin{itemize}
  \item Retirements are relatively predictable
